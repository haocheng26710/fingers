...
The processing event ledger is an internal integrity/audit relationship, not a signed or externally witnessed security log. It does not claim protection against coordinated malicious rewriting of both event and artifact bytes.
